...
def solve_z3(constraints: List, x: List):
  """Satisfying model for constraints, generated by Z3.
...
class Verifier_Reach_ABV_CVC5(Verifier_Reach_ABV):
  def chk_dec(self):
    ...
    # logger.debug('bounds=' + pprint.pformat(bounds))
    # logger.debug('problem=' + pprint.pformat(problem))
    x_cvc5 = [cvc5.Real(f'x_{i}') for i in range(dim)]
    constraints = bounds + problem
    ...
    return solve_cvc5(constraints, x_cvc5)
